    ...
    >
      ...
      >
        <NuxtLink
          ...
          class="nui-focus relative -left-0.5 flex cursor-pointer items-center gap-2 border-s-2 border-transparent py-2 ps-4 text-muted-500 transition-colors duration-300 hover:text-muted-600 dark:text-muted-400/80 dark:hover:text-muted-200"
        >
          <Icon
