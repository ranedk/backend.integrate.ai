...
<template>
  <div
    class="fixed left-0 top-0 z-[60] flex h-full flex-col border-r border-muted-200 bg-white transition-all duration-300 dark:border-muted-700 dark:bg-muted-800"
    :class="[
